  ...
  const categories = [
    {
      id: 1,
      name: "Housing",
      description: "Manage rent, mortgage, and housing-related expenses",
    ...
    },
    {
      id: 2,
      name: "Finance",
      description: "Track income, savings, and financial growth",
    ...
    },
    {
      id: 3,
      name: "Food & Dining",
      description: "Monitor grocery and restaurant spending",
    ...
    },
    {
      id: 4,
      name: "Transportation",
      description: "Track vehicle costs and commuting expenses",
      ...
      >
        {categories.map((category) => (
          <motion.div
            ...
            className={`bg-gradient-to-br ${category.gradient} rounded-xl shadow-lg p-6 text-white cursor-pointer relative overflow-hidden group`}
          >
            {/* Glow effect */}
